var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-p6pvjw");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-p6pvjw");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [secondsLeft, isRunning, progress, handleClick];
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="howtowashhands.gif" alt="Washing Hands" class="svelte-1tgj0z7">`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
